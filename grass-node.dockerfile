...
ARG GRASS_LOGIN_URLS
ARG MAX_RETRY_MULTIPLIER
ARG RECAPTCHA_RESOLVER_IDS
ARG RECAPTCHA_RESOLVER_URLS
...
ENV GRASS_LOGIN_URLS=${GRASS_LOGIN_URLS}
ENV MAX_RETRY_MULTIPLIER=${MAX_RETRY_MULTIPLIER}
ENV RECAPTCHA_RESOLVER_IDS=${RECAPTCHA_RESOLVER_IDS}
ENV RECAPTCHA_RESOLVER_URLS=${RECAPTCHA_RESOLVER_URLS}
